...
function App() {
  ...
  function checkWinner() {
    ...
    for (let i=0; i<matrixValues.length; i++){
      if(matrixValues[i] ==="empty")
        break;
      if(i===matrixValues.length-1)
  ...
  return (
    <div className="App">
      ...
      {isWinner ? (
        ...
        <h2 className='turn'>
          {crossTurn ? "Cross" : "Cricle"}'s Turn ⚒️
        </h2>
      )}
      <Row>
